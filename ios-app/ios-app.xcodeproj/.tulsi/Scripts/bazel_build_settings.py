...
BUILD_SETTINGS = BazelBuildSettings(
    '/usr/local/bin/bazel',
    '/private/var/tmp/_bazel_ducnv29/8cac1e46e3e7cbb81116938ee617fadb/execroot/__main__',
    'ios_x86_64',
    {
        'tvos_arm64': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/ducnv29/Library/Application Support/Tulsi/0.20200624.88/Bazel',
